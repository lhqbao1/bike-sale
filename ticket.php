    ...
    ?>
        <div id="main-products">
            <div class="first-main-product">
                ...
                <p style="text-align: center;"> <?php echo $row['band'] ?></p>
                <h3 style="margin-left: 5px;"> <?php echo $row['places'] ?></h3>
                <h6 style="margin-left: 5px;"> Price: <?php echo $row['price'] ?></h6>
                <h5 style="color: brown; margin-left: 5px;"> Date: <?php echo $row['date'] ?> <a style="text-decoration: none; float: right; margin-right: 20px; padding: 10px; background-color: #ccc; margin-bottom: 10px" href="ticket-details.php?id=<?= $row['id'] ?>">Add to cart</a>
                </h5>
            </div>
        </div>
    <?php } ?>
